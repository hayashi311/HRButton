...
// HRButton
#define COCOAPODS_POD_AVAILABLE_HRButton
#define COCOAPODS_VERSION_MAJOR_HRButton 0
#define COCOAPODS_VERSION_MINOR_HRButton 1
#define COCOAPODS_VERSION_PATCH_HRButton 0
